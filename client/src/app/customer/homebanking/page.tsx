    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='flex flex-col item-center justify-center gap-10 h-[93vh]'>
        ...
        <div className='flex flex-col justify-center text-center gap-8 px-5 max-w-[700px]'>
          ...
          <Link href="homebanking/change-password" className="overflow-y-hidden shadow-md shadow-indigo-600 rounded-md desktop:text-4xl   text-xl p-3 bg-indigo-500  hover:bg-indigo-600 hover:text-white transition-all ease-in duration-200 h-[50%]">
            Cambiar Contraseña
          </Link>
        </div>
      </div>
