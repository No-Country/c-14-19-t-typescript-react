...
const BankAccounts = ({ params }: any): React.ReactElement => {
    ...
    return (
        <div className="flex flex-col items-center w-full h-screen mt-5 gap-16">
            <h2 className="text-3xl overflow-y-hidden">Tus Cuentas</h2>
            <div className=" shadow-stone-700 shadow-md w-[90%] tablet:w-[70%] items-center justify-center flex  flex-col gap-5 pb-5 pt-5">
                {accountsList.length === 0 ? (
                    ...
                    accountsList.map((account: any, index: any) => (
                        ...
                        >
                            <p className="overflow-y-hidden text-[#333333]">{account.number_account}</p>
                            <p className=" text-[#FF5722] font-bold p-1">${account.money}</p>
                            <div className="flex gap-5">
                                ...
                                <button
                                    ...
                                    className={`overflow-y-hidden flex items-center justify-center font-bold p-3 text-[#333333] tablet:p-2 rounded-md bg-[#FFA17A] hover:bg-[#FF5722] desktop:w-[120px] text-center hover:text-white transition-all ease-in duration-200 capitalize ${loadingButtonIndex === index ? "pointer-events-none" : ""
                                        }`}
                                >
